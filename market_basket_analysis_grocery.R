...
#Find Frequent Items
frequentItems = eclat (Groceries, parameter = list(supp = 0.01, minlen= 2, maxlen = 5)) #if 10000 times purchased then 10000*0.01=100 times purchase
...
abline(h=0.15)# Create rules and the relationship between items
